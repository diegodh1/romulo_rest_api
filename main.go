...
func main() {
	...
	r.GET("/client/search/:id", routes.SearchClient(db))
	...
	r.GET("/pedido/get/bodegas/:userID", routes.GetBodegas(db))
	r.GET("/pedido/get/color/:code/:list/:bodega", routes.GetExt1(db))
	r.GET("/pedido/get/talla/:code/:list/:ext1/:bodega", routes.GetExt2(db))
